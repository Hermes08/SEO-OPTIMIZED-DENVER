...
// real, verifiable business data before production. Structured data (PostalAddress,
// geo, AggregateRating, Review) is gated behind the VERIFICATION FLAGS further down
// so the site never emits fabricated data — flip a flag to true only once its data
// is real. Outstanding: PHONE_NUMBER, EMAIL_ADDRESS, ADDRESS, ZIP_CODE,
// GOOGLE_BUSINESS_URL, GOOGLE_RATING, GOOGLE_REVIEW_COUNT, LICENSE_NUMBER, SOCIAL_LINKS.
export const COMPANY_NAME = "Denver Metro Services";
export const PHONE_NUMBER = "303-555-0123"; // TODO(NAP): real tracking number (555-01xx is reserved fictional)
export const CITY = "Denver";
export const STATE = "CO";
export const REGION = "Denver Metro Area";
export const ADDRESS = "123 Speer Blvd, Suite 100"; // TODO(NAP): real street address (only emitted when HAS_PHYSICAL_ADDRESS)
export const ZIP_CODE = "80204"; // TODO(NAP): confirm with real address
export const EMAIL_ADDRESS = "service@denvermetroservices.com"; // TODO(NAP): confirm domain is real & inboxed

// --- VERIFICATION FLAGS (gate structured data on real, substantiable values) ---
// Set to true ONLY when the corresponding data is real and verifiable.
export const HAS_PHYSICAL_ADDRESS = false; // true => emit PostalAddress + geo in LocalBusiness schema
export const HAS_VERIFIED_REVIEWS = false; // true => emit AggregateRating / Review schema + numeric rating UI
export const GEO_COORDS = { latitude: 39.7392, longitude: -104.9903 }; // only used when HAS_PHYSICAL_ADDRESS
export const LICENSE_NUMBER = ""; // TODO(NAP): real CO license #; empty => hidden in UI
// Real social profile URLs. Empty until provided so we never link to non-existent pages.
export const SOCIAL_LINKS: { platform: 'facebook' | 'instagram' | 'linkedin'; url: string }[] = [];
...
export const GOOGLE_REVIEWS = [
  { id: 'g1', author: 'Robert Fox', avatar: initialsAvatar('Robert Fox'), rating: 5, text: 'Technician was incredibly professional and fixed our issue within an hour. The pricing was exactly as quoted. Highly recommend for residential electrical services in Denver!', date: '2 weeks ago' },
  { id: 'g2', author: 'Kristin Watson', avatar: initialsAvatar('Kristin Watson'), rating: 5, text: 'I have used many service companies in Denver but these guys are the best plumbers. Fixed my frozen pipes fast. Clean, courteous, and very knowledgeable.', date: '1 month ago' },
  { id: 'g3', author: 'Cody Fisher', avatar: initialsAvatar('Cody Fisher'), rating: 4, text: 'Great experience with our AC repair. Scheduling was easy and they showed up on time. Good communication throughout the process.', date: '2 months ago' },
...
export const CATEGORIES: Category[] = [
  {
    ...
    heroImage: '/images/ev-charger-hero.webp',
    ...
    subServices: [
      {
        ...
        image: '/images/ev-charger-hero.webp',
      ...
      },
      {
        ...
        image: '/images/commercial-ev.webp',
  ...
  },
  {
    ...
    heroImage: '/images/plumbing-hero.webp',
    ...
    subServices: [
      {
        ...
        image: '/images/plumbing-action.webp',
  ...
  },
  {
    ...
    heroImage: '/images/hvac-hero.webp',
  ...
  },
  {
    ...
    heroImage: '/images/solar-hero.webp',
    ...
    subServices: [
      ...
      },
      {
        ...
        image: '/images/solar-action.webp',
  ...
  },
  {
    ...
    heroImage: '/images/roofing-hero.webp',
    ...
    subServices: [
      {
        ...
        image: '/images/roofing-action.webp',
  ...
  },
  {
    ...
    heroImage: '/images/general-hero.webp',
    ...
    subServices: [
      ...
      },
      {
        ...
        image: '/images/general-action.webp',
...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    image: '/images/electrical-action.webp',
...
// TODO(NAP): replace name/logo with the real lenders the business is approved with
// (e.g. Wisetack, GreenSky, Synchrony). Text logos are neutral placeholders, not real brand art.
export const FINANCING_PARTNERS = [
  { id: 1, name: 'Financing Partner', logo: textLogo('Financing Partner') },
  { id: 2, name: 'Flexible Plans', logo: textLogo('Flexible Plans') },
  { id: 3, name: 'Approved Lender', logo: textLogo('Approved Lender') },
];
...
export const TEAM_MEMBERS = [
  { id: 1, name: 'John Smith', role: 'Founder & CEO', image: initialsAvatar('John Smith', 300) },
  { id: 2, name: 'Jane Doe', role: 'Operations Manager', image: initialsAvatar('Jane Doe', 300) },
