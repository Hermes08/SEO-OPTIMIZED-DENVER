...
export async function generateMetadata({ params }: { params: Promise<{ stateSlug: string }>; }) {
    ...
    return {
        ...
        openGraph: { type: 'website', title, description, url, images: [{ url: '/images/general-hero.png', alt: title }] },
        twitter: { card: 'summary_large_image', title, description, images: ['/images/general-hero.png'] },
    };
}
...
export default async function StatePage({ params }: { params: Promise<{ stateSlug: string }>; }) {
    ...
    const serviceSchema = {
        ...
        image: `${BASE_URL}/images/general-hero.png`,
