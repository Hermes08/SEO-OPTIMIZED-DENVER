...
import { CATEGORIES, COMPANY_NAME, CITY, STATE, GENERATE_CONTENT } from '../constants';
    ...
    <>
      ...
      <section className="py-20 bg-gray-900" aria-labelledby="local-area-heading">
        <div className="container mx-auto px-4 text-center">
            ...
            <Link to="/areas-we-serve" className="text-orange-500 hover:text-white font-bold underline decoration-orange-500 underline-offset-4 focus:outline-none focus:ring-2 focus:ring-orange-500 rounded px-1">
