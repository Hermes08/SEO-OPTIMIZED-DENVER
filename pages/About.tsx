...
import { HISTORY_TEXT, VALUES, TEAM_MEMBERS, COMPANY_NAME } from '../constants';
    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 bg-gray-800">
             {/* Abstract background shape or image overlay */}
             <div className="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')]"></div>
        </div>
        <div className="container mx-auto px-4 relative z-10 text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">About {COMPANY_NAME}</h1>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-white mb-12 text-center">Meet The Experts</h2>
      ...
      <section className="py-16 bg-gray-800 border-t border-gray-700">
        <div className="container mx-auto px-4 text-center">
            <h2 className="text-2xl font-bold text-white mb-8">Licensed & Certified</h2>
            <div className="flex justify-center gap-8 flex-wrap text-gray-400">
                <div className="flex items-center gap-2 px-6 py-3 bg-gray-900 rounded-full">
                    <Shield size={20} className="text-orange-500" /> Fully Insured
                </div>
                <div className="flex items-center gap-2 px-6 py-3 bg-gray-900 rounded-full">
                    <Award size={20} className="text-orange-500" /> State Licensed
                </div>
                <div className="flex items-center gap-2 px-6 py-3 bg-gray-900 rounded-full">
                    <Users size={20} className="text-orange-500" /> Background Checked
                </div>
            </div>
        </div>
      </section>
      ...
      {/* CTA */}
      <section className="py-20 bg-gradient-to-r from-orange-600 to-orange-500 text-center">
        <div className="container mx-auto px-4">
